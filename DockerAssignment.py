...
for eachkey in TextFilesWordCounts.keys():
    ...
    outputString = outputString + \
        ...
        str(TextFilesWordCounts.get(eachkey))+"\n"

outputString = outputString + "\n"
outputString = outputString + \
    "************|| grand total (total number of words in both files) ||************\n"
outputString = outputString + "total number of words in both files [" + AllFilesNames[0:len(
    AllFilesNames) - 1] + "] is: " + str(AllFilesWordCount)+"\n"
